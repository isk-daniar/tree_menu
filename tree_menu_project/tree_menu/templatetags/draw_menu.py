...
def build_querystring(context: Context, menu: str):

    """ Создает строку запроса на основе текущего контекста запроса """
    ...
    # Возвращает построенные строки запроса
    return querystring
...
def get_selected_item_id_list(parent: MenuItem, primary_item: List[MenuItem], selected_item_id: int):

    """
    Возвращает список идентификаторов выбранных пунктов меню,
    начиная с родительского элемента и заканчивая текущим
    """
